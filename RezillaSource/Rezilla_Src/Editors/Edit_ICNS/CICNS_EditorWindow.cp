...
void
CICNS_EditorWindow::FindCommandStatus(
	CommandT	inCommand,
	Boolean		&outEnabled,
	Boolean		&outUsesMark,
	UInt16		&outMark,
...
Boolean
CICNS_EditorWindow::ObeyCommand(
	CommandT	inCommand,
	void*		ioParam)
{
...
Boolean
CICNS_EditorWindow::HandleKeyPress(
...
void
CICNS_EditorWindow::AddStringItem(Str255 inString)
{
...
void
CICNS_EditorWindow::CreateItemAtIndex(UInt16 index, Str255 inString, SInt32 inHowMany)
{
...
void
CICNS_EditorWindow::InsertStringItemAtIndex(UInt16 index, Str255 inString)
{
...
void
CICNS_EditorWindow::RecalcPositionAtIndex(UInt16 index)
{
	CIndexedEditField * theField;
...
void
CICNS_EditorWindow::RecalcAllPositions()
{
...
void
CICNS_EditorWindow::RecalcPositionsInRange(UInt16 inStart, UInt16 inEnd)
{
	if (inStart > inEnd) {
		UInt16 pos = inEnd;
		inEnd = inStart;
...
UInt16
CICNS_EditorWindow::GetFirstSelected()
{
...
UInt16
CICNS_EditorWindow::DeleteSelectedItems()
{
...
void
CICNS_EditorWindow::GetIndexFromPoint(
...
void
CICNS_EditorWindow::DrawDividingLine( UInt16 inRow )
{
	if (inRow == -1) {return;} 
