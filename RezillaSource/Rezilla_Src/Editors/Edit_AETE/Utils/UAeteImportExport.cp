...
//             Last modification : 2006-10-01 18:42:31
...
StAeteExporter::WriteOutXml()
{
	...
	theStream->WriteTag("!DOCTYPE AeteResource SYSTEM \"file://localhost/System/Library/DTDs/aete.dtd\"", tag_open);

	if (mRezObj != nil) {
		LString::CopyPStr(*(mRezObj->GetName()), theName);
		theStream->WriteCStringNoEnc("<!--Generated by Rezilla from aete resource '");		
		*theStream << (SInt32) mRezObj->GetID() << "' - " << theName;
