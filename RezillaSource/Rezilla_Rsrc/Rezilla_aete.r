...

{
	...
	"Useful events that arenÍt in any other suite",
	'misc',
	0,
	0,
		{
	...
	,
	"odds and ends",
	"Things that should be in some standard suite, but arenÍt",
	'Odds',
	1,
	1,
		{
				...
				"SetTellTarget",
				"Makes an object the ñfocusî of AppleEvents",
				'ppnt',
				'sttg',
				'null',
				"",
